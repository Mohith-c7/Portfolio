      ...
      <section id="about" className="bg-black text-white py-16 md:py-24 relative overflow-hidden">
        ...
        >
          <div className="mb-12 px-4 md:px-8">
            ...
            >
              {[
                <>I've always been fascinated by how digital products come to life. My journey began with exploring user experiences, visual design, and the way people interact with software. That curiosity led me into <span className="text-lime-400 font-semibold">UX design</span>, where I learned to think deeply about usability, accessibility, and solving real user problems.</>,
                <>As I worked more closely with engineering teams, I noticed a recurring gap between carefully crafted designs and what was ultimately built. I wanted to understand why those differences existed, and more importantly, learn how to <span className="text-lime-400 font-semibold">bridge them</span>. That curiosity pushed me beyond design and into software development.</>,
                <>I started learning frontend development to bring my own designs to life, but my interest quickly expanded into backend engineering, databases, APIs, and <span className="text-white font-semibold">system architecture</span>. Today, I enjoy building complete software products that combine thoughtful user experiences with scalable, maintainable engineering.</>,
                <>Currently, I work as a Software Engineer with experience across <span className="text-lime-400 font-semibold">full-stack development</span>, backend systems, and AI-powered applications. I'm continuously exploring new domains such as distributed systems, cloud technologies, cybersecurity, and intelligent software, always looking for better ways to solve real-world problems through technology.</>
              ].map((content, idx) => (
                <motion.p
                  key={idx}
